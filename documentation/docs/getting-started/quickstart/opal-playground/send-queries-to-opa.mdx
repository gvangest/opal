...
The default policy in the [example repo](https://github.com/gvangest/opal-example-policy-repo) is a simple
...
The expected resonse should be like the one below.
