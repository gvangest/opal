...
def setup_webhook_listener(
    ...
    # load defaults
    server_uri = load_conf_if_none(server_uri, opalserver_config.OPAL_WS_LOCAL_URL)
    server_token = load_conf_if_none(server_token, opalserver_config.OPAL_WS_TOKEN)
