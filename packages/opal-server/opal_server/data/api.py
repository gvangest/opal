...
def init_data_updates_router(
    ...
    @router.get(opalserver_config.ALL_DATA_ROUTE)
    ...
    @router.post(
        opalserver_config.DATA_CALLBACK_DEFAULT_ROUTE,
    ...
    @router.get(
        opalserver_config.DATA_CONFIG_ROUTE,
    ...
    @router.post(opalserver_config.DATA_CONFIG_ROUTE)
